        ...
        <>
            <GridContainer>
                {rows && rows.map((x, index) => (
                    <React.Fragment key={`${x.TrainingsId}_${index}`} >
                        <CardItem keyid={x.TrainingsId} row={x} title={x.CompleteBy}  width={300}
                            footerItems={[]} description={x.TrainingsId} onActionClicked={OnActionClicked}>
